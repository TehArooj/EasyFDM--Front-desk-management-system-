<?php 
  ...
  $role_id = 2;
  $root_url = "../admin/";
  $page_name = "rpt_airportPickup.php";
  $page_section = 1;
  ...
  $query = "SELECT  BOOKING_ID, BOOKING_NO, t2.NAME, ARRIVAL_ON, DEPARTURE_ON, CONCAT(t3.ROOM_NO, '-', t4.SHORT_NAME) ROOM_NO , t3.RATE, STATUS
            ...
            WHERE   t1.guest_id = t2.guest_id
                ...
                AND t1.AIRPORTPICKUP = 1
                AND t1.ARRIVAL_ON > NOW()
            ORDER BY BOOKING_NO";
...
<head>
    ...
    <title>Airport Pickup List</title>
        ...
        <div class="content-wrapper" style="min-height: 725px;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Airport Pickup List</h1>
                        </div><!-- /.col -->
