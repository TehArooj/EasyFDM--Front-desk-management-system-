<?php 
  ...
  $role_id = 2;
  $root_url = "../admin/";
  $page_name = "fd_guests.php";
  $page_section = 1;
  $page_url = $root_url . $page_name;
  $edit_page = $root_url . 'fd_newGuest.php';
  ...
  // Select grid data.
  $query = "SELECT GUEST_ID, NAME, CNIC, PASSPORT_NO, PHONE, FAX, EMAIL, ACTIVE FROM guest ORDER BY GUEST_ID";
  ...
  if(isset($_GET['action']) && isset($_GET['recid']) && htmlspecialchars($_GET['action']) == "delete" )  
  {
    ...
    $query = "DELETE FROM guest WHERE GUEST_ID = $recid";
        ...
        <div class="content-wrapper" style="min-height: 725px;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Guests</h1>
                        </div><!-- /.col -->
                            ...
                            echo "<tr>";
                              ...
                              echo "<td>
                                        <div class='icheck-primary d-inline ml-2'>
                                            <input type='checkbox' " . ($row[7] == 1 ? 'checked' : '') . " disabled>
                                            <label />
                                        </div>
                                      </td>";
