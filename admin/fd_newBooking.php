<?php 
  ...
  $role_id = 2;
  $root_url = "../admin/";
  $page_name = "fd_newBooking.php";
  $page_section = 1;
  $page_url = $root_url . $page_name;
  $list_page = $root_url . 'fd_bookings.php';
  ...
  $query = "SELECT GUEST_ID, NAME, EMAIL FROM guest where ACTIVE = 1";
  ...
  if ( isset($_POST['btn_add']) && $recid == 0 )
  {
    ...
    $rate_id = mysqli_real_escape_string($db, $_POST['rate_id']);
    ...
    if (empty($rate_id)) { array_push($errors, "Room Rate is required.");  }
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="room_rates" class="custom-select" name="rate_id">
                                                        <option value="0"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="extra_bed_rate"  id="extra_bed_rate" value="<?php echo $extra_bed_rate;?>" <?php echo ($extra_bed_active=="0") ? 'readonly':''; ?> onchange="calcExtraBed();">
                                                </div>
                                            </div>
    ...
    $(document).ready(function() {
        $("#extra_bed_active").change(function() {
            ...
            if (active === "0") {
                ...
                $('#extra_bed_rate').prop("readonly", true);
                ...
                $('#extra_bed_rate').prop("readonly", false);
            }
