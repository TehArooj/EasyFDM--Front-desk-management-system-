<?php 
  ...
  $query = "SELECT GUEST_ID, NAME, CNIC, PASSPORT_NO, PHONE, FAX, EMAIL, ACTIVE FROM guest WHERE CREATED_BY = $user_id";
  ...
  if (isset($_POST['btn_update']) && $mode="edit")
  {
    ...
    if (count($errors) == 0) {
      ...
      if ($pass==false) {
        ...
        header('location:  ' . $page_name  . '?updated=1');
      }
    }
  }
                                        ...
                                        <div class="row">
                                            <div class="container-fluid">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a href="<?php echo $page_name ?>" class="btn btn-danger float-right"><i class="fas fa-plus-square" aria-hidden="true"></i> Cancel</a>
                                                    <button type="submit" class="btn btn-success float-right" name="btn_update"><i class="far fa-plus-square"></i>&nbsp;&nbsp;Update</button>                                 
                                                </div>
                                            </div>
